...
class MunicipalitySerializer(serializers.ModelSerializer):
	...
	class Meta:
		...
		fields = ('name', 'code', 'kennzahl', 'regional_electoral_district', 'district')
...
class PartySerializer(serializers.ModelSerializer):
	...
	class Meta:
		model = models.Party
		fields = ('short_name', 'short_name_text', 'full_name', 'family', 'wikidata_id', 'wikidata_url', 'website')
...
class PollingStationResultSerializer(serializers.ModelSerializer):
	...
	class Meta:
		...
		fields = ('election', 'polling_station', 'election', 'eligible_voters', 'votes', 'valid', 'invalid', 'ts_result')
